                ...
                <div className="container mx-auto px-4 py-4 sm:py-6">
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 sm:gap-0">
                        <div className="flex items-center space-x-3 sm:space-x-4">
                            ...
                            <div>
                                <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-foreground">{project.name}</h1>
                                {project.description && (
            ...
            <main className="container mx-auto px-4 py-4 sm:py-8">
                ...
                <Card className="mb-6 sm:mb-8">
                    <CardHeader className="pb-3 sm:pb-6">
                        <CardTitle className="text-lg sm:text-xl">Upload Design Images</CardTitle>
                    ...
                    <CardContent>
                        <div
                            ...
                            onDrop={handleDrop}
                        >
                            <Upload className={`w-8 h-8 sm:w-12 sm:h-12 mx-auto mb-3 sm:mb-4 ${dragActive ? 'text-primary' : 'text-muted-foreground'
                                }`} />
                    ...
                    {images.length === 0 ? (
                        <Card>
                            <CardContent className="flex flex-col items-center justify-center py-8 sm:py-12">
                                <Eye className="w-8 h-8 sm:w-12 sm:h-12 text-muted-foreground mb-3 sm:mb-4" />
                                ...
                                <Card key={image._id} className="overflow-hidden hover:shadow-md transition-shadow">
                                    ...
                                    <CardContent className="p-3 sm:p-4">
                                        <div className="flex items-center justify-between mb-2">
                                            <h3 className="font-medium truncate text-sm sm:text-base" title={image.filename}>
                                                {image.filename}
                                            </h3>
